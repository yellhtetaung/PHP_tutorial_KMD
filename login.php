...
<body>
    <main class="container mt-5">
        <h1 class="text-center display-6 text-info fw-bold text-uppercase">Login Form</h1>

        <form action="process/login_process.php" method="post" class="col-12 col-md-8 col-lg-6 mx-auto">
            <div class="mb-3">
        ...
        <p class="text-center mt-5">Don't have an account? <a href="register.php">Register here.</a></p>
    </main>
